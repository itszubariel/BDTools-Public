...
function showApp(user: DiscordUser, apiKey: string): void {
  _apiKey = apiKey;
  ...
  if (typeof (window as any).onAppReady === "function") {
    (window as any).onAppReady(user, apiKey);
  }
}

function renderKey(visible: boolean): void {
